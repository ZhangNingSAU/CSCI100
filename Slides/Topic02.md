...
+ More examples(If you want to learn how to convert decimal numbers into binary manually, see [link 1](https://www.cuemath.com/numbers/decimal-to-binary/) and [link 2](https://www.log2base2.com/number-system/float-to-binary-conversion.html))
